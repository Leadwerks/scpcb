...
To solve this problem, our build uses [WineD3D for Windows](https://fdossena.com/?p=wined3d/index.frag) to translate the game's DirectX 7 calls into OpenGL, which has better driver support. Based on the same technology as Valve's Proton, this ensures that the game remains free and open-source for all developers to access. This solution can be used for all versions of the game, not just ours. To enable WineD3D for Windows just copy these two files into your game directory:
- ddraw.dll
- wined3d.dll
