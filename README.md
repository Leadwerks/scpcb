...
3. Click the [b]Program[/b] menu and make sure the [b]Debug Enabled?[/b] menu item is deselected. This will ensure that you create a release build instead of a slower debug build.
4. Select the [b]Program > Create Executable[/b] menu item to compile the game. You must have the file SCPCB.bb selected in the tabbed panel when you do this, as the selected file is used to indicate the main file to start compiling with.
